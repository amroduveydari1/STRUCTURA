...
const ARSection: React.FC<ARSectionProps> = ({ lang }) => {
  const t = UI_STRINGS[lang].arScanner;
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          <div className="order-2 lg:order-1">
            <div className="flex items-center space-x-4 rtl:space-x-reverse mb-6">
              ...
              <span className="text-amber-500 font-architectural font-bold uppercase tracking-[0.4em] text-[10px]">{t.subtitle}</span>
            </div>
            
            <h2 className="text-4xl md:text-6xl font-architectural font-bold text-white mb-8 tracking-tighter uppercase leading-none">
              {t.title.split(': ')[0]}: <br />
              <span className="text-zinc-600">{t.title.split(': ')[1]}</span>
            </h2>
            ...
            <div className="space-y-6 mb-12">
              <div className="flex items-start space-x-4 rtl:space-x-reverse">
                ...
                <div>
                  <h4 className="text-white text-xs font-architectural font-bold uppercase tracking-widest mb-1">{t.step1Title}</h4>
                  <p className="text-zinc-500 text-[11px] leading-relaxed">{t.step1Desc}</p>
                </div>
              </div>
              <div className="flex items-start space-x-4 rtl:space-x-reverse">
                <div className="w-8 h-8 rounded bg-amber-500/10 flex items-center justify-center shrink-0 border border-amber-500/20">
                ...
                <div>
                  <h4 className="text-white text-xs font-architectural font-bold uppercase tracking-widest mb-1">{t.step2Title}</h4>
                  <p className="text-zinc-500 text-[11px] leading-relaxed">{t.step2Desc}</p>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-6 rtl:space-x-reverse">
              {!isScanning ? (
                <button 
                  onClick={startScan}
                  className="bg-amber-600 hover:bg-amber-700 text-white px-12 py-6 font-architectural font-bold uppercase tracking-[0.3em] text-[10px] transition-all flex items-center justify-center space-x-4 rtl:space-x-reverse shadow-2xl"
                >
                ...
                <div className="flex flex-col sm:flex-row gap-4 w-full">
                  <button 
                    ...
                    className="flex-1 bg-white hover:bg-zinc-200 text-zinc-950 px-12 py-6 font-architectural font-bold uppercase tracking-[0.3em] text-[10px] transition-all flex items-center justify-center space-x-4 rtl:space-x-reverse disabled:opacity-50"
                  >
                    {isAnalyzing ? (
                      <>
